  ...
  return (
    <section className={styles.container} id="sobre">
      <div className={styles.content}>
        <h1>Sobre Nós</h1>
        <p>
          Nossa <strong>Missão</strong> é proporcionar a operação de entregas de forma simples e inteligente. Temos como <strong>Visão</strong>:
          tornar-se uma referência em entregas rápidas, confiáveis e eficientes para empresas em Fortaleza, tendo como <strong>Valores</strong>:
          respeito, honestidade, cordialidade, inteligência e agilidade.
        </p>
        <h2>Onde estamos</h2>
        <p>
          Estamos em <strong>Fortaleza</strong> e entregamos em toda capital e região metropolitana.
        </p>
        <h2>A quem atendemos</h2>
        <p>
          Atendemos à empresas, e-commerces/lojas virtuais que desejam
          <strong> simplificar</strong> a operação com entrega em Fortaleza e região metropolitana.
        </p>
