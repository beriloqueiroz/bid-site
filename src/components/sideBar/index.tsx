      ...
      <nav className={style.nav}>
        <ul className={style.ul}>
          ...
          <li className={style.liSocial}>
            ...
            <a className={style.li_a} href="http://www.intagram.com/bid.log" target="_blank" rel="noopener noreferrer">
              @bid.log
            </a>
          </li>
          <li className={style.liSocial}>
            ...
            <a className={style.li_a} href="https://www.linkedin.com/company/bid-log" target="_blank" rel="noopener noreferrer">
              bid.log
            </a>
          </li>
        </ul>
