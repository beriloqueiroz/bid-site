    ...
    <Layout simpleHeader={true}>
      <section className={style.section}>
        <div className={style.container}>
          ...
          <p>
            A sua privacidade é importante para nós. É política da bid respeitar
            a sua privacidade em relação a qualquer informação sua que possamos
            coletar no site <a href='http://bid.log.br'>bid</a>, e outros sites
          ...
          <p>
            ...
            isso pode fazer o downgrade ou &sbquo;quebrar&sbquo; certos
          ...
          <p>
            ...
            informação que o bid oferece no site e com caráter enunciativo, mas
            não limitativo:
          </p>
          <ul>
            <li>
            ...
            <li>
              ...
              (softwares) da bid, de seus fornecedores ou terceiros, para
